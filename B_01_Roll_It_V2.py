...
def initial_points(which_player):
    '''Roll dice twice and return goal / if double points apply'''
...
while comp_score < game_goal and user_score < game_goal:
    ...
    # Outside round loop - Update score with round points, only add points to the score of the winner
...
if user_score > comp_score:
    ...
    make_statement(statement= "The computer won", decoration= "🖥️")
